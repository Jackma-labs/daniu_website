    ...
    <section className="flex min-h-[calc(100dvh-4rem)] flex-col items-center px-4 pb-12 pt-8 md:px-6 md:pt-10">
      <div className="w-full max-w-6xl">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-3xl font-semibold tracking-tight md:text-4xl">把资料喂进去，大牛会自己学习</h1>
          <p className="mx-auto mt-3 max-w-2xl text-balance text-base leading-7 text-muted-foreground">
